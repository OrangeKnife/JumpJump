...
/// </summary>
public class ColorJumpShopEventHandler {
	...
	/// </summary>
	public ColorJumpShopEventHandler () {
	...
	public void onMarketRefund(PurchasableVirtualItem pvi) {
		Utils.addLog ("onMarketRefund called: itemid=" + pvi.ItemId);
	}
	...
	public void onMarketPurchaseStarted(PurchasableVirtualItem pvi) {
		Utils.addLog ("onMarketPurchaseStarted called: itemid=" + pvi.ItemId);
	}
